...
# FIX: Use PVDReader for .pvd files as identified from debug output
...
# and 'turbine_geometry.vtp' in 'data/testing-input-output/vtk_output/'
# We'll prioritize the .obj if specified, otherwise the .vtp generated by your script.
